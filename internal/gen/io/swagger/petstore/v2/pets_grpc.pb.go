...
func (c *petServiceClient) UploadFile(ctx context.Context, in *UploadFileReq, opts ...grpc.CallOption) (*ApiResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponse)
	err := c.cc.Invoke(ctx, PetService_UploadFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *petServiceClient) FindPetsByTag(ctx context.Context, in *TagReq, opts ...grpc.CallOption) (*Pets, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Pets)
	err := c.cc.Invoke(ctx, PetService_FindPetsByTag_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPetServiceServer) FindPetsByTag(context.Context, *TagReq) (*Pets, error) {
	return nil, status.Error(codes.Unimplemented, "method FindPetsByTag not implemented")
}
